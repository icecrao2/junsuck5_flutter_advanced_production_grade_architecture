...
class SignInScreen extends StatelessWidget {
  ...
  const SignInScreen({super.key, required this.onTapSignUp, required this.onTapSignIn});
      ...
      body: SafeArea(
        ...
        child: Column(
          ...
          children: [
            ...
            const InputField(label: 'Enter Password', placeHolder: "Enter Password"),
            const SizedBox(
              height: 20,
            ),
            Text(
              'Forgot Password?',
              style: TextStyles.smallerTextRegular.copyWith(color: ColorStyles.secondary100),
            ),
            const SizedBox(
              height: 25,
            ),
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  'Or Sign in With',
                  style: TextStyles.smallerTextBold.copyWith(color: ColorStyles.gray4),
                ),
                const SizedBox(
                  width: 7,
                ),
            ...
            Row(
              children: [
                ...
                GestureDetector(
                  ...
                  child: Text(
                    'Sign up',
                    style: TextStyles.smallerTextBold.copyWith(color: ColorStyles.secondary100),
                  ),
                )
              ],
            )
