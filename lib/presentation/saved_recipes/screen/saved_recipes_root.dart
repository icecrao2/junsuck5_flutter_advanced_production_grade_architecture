...
final _getSavedRecipesUseCase = GetSavedRecipesUseCase(
    recipeRepository: MockRecipeRepositoryImpl(recipeDataSource: RemoteRecipeDataSourceImpl()), bookmarkRepository: MockBookmarkRepositoryImpl());
...
class SavedRecipesRoot extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final viewModel = SavedRecipesViewModel(getSavedRecipesUseCase: _getSavedRecipesUseCase);
